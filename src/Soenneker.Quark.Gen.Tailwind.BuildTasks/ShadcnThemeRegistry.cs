...
// Data copied from shadcn-ui/ui apps/v4/registry/themes.ts at commit 3751fdfa4c56bc96e8738497ee29d0f4750c9b13.
internal static class ShadcnThemeRegistry
{
    public const string SourceCommit = "3751fdfa4c56bc96e8738497ee29d0f4750c9b13";

    private static readonly string[] _baseColorNames =
    [
        "neutral",
        "stone",
        "zinc",
    ...
    private static readonly HashSet<string> _baseColorNameSet = new(_baseColorNames, StringComparer.OrdinalIgnoreCase);

    private static readonly Dictionary<string, ShadcnTheme> _themes = new(StringComparer.OrdinalIgnoreCase)
    {
        ["neutral"] = new ShadcnTheme(
    ...
    public static IReadOnlyList<string> BaseColorNames => _baseColorNames;

    public static IReadOnlyList<string> ThemeNames => _themeNames;

    public static bool IsBaseColorName(string name) => _baseColorNameSet.Contains(name);
